<?php 
    ...
    // Global Variables
    $setName = "Lorwyn"; // Used for Categories in Crystal Commerce
    $tableName = "lorwyn"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/lorwyn"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Lorwyn/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: 10thEdition.php");
    // ****** END CHAIN SCRIPTS ******
?>