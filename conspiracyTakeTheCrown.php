<?php 
    ...
    // Global Variables
    $setName = "Conspiracy: Take the Crown"; // Used for Categories in Crystal Commerce
    $tableName = "conspiracyTakeTheCrown"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/conspiracy-take-the-crown"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Conspiracy:%20Take%20the%20Crown/foil";
