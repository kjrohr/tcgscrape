<?php 
    ...
    // Global Variables
    $setName = "Fourth Edition"; // Used for Categories in Crystal Commerce
    $tableName = "fourthEdition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/fourth-edition"; // URL to scrape
