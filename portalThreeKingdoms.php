<?php 
    ...
    // Global Variables
    $setName = "Portal Three Kingdoms"; // Used for Categories in Crystal Commerce
    $tableName = "portalThreeKingdoms"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/portal-three-kingdoms"; // URL to scrape
  ...
  // ****** GENERATE MASTER CSV ******
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: classicSixthEdition.php");
    // ****** END CHAIN SCRIPTS ******
?>