<?php 
    ...
    // Global Variables
    $setName = "Classic Sixth Edition"; // Used for Categories in Crystal Commerce
    $tableName = "classicSixthEdition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/classic-sixth-edition"; // URL to scrape
  ...
  // ****** GENERATE MASTER CSV ******
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: starter1999.php");
    // ****** END CHAIN SCRIPTS ******
?>