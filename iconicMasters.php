<?php 
    ...
    // Global Variables
    $setName = "Iconic Masters"; // Used for Categories in Crystal Commerce
    $tableName = "iconicMasters"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/iconic-masters"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Iconic%20Masters/foil";
