<?php 
    ...
    // Global Variables
    $setName = "Aether Revolt"; // Used for Categories in Crystal Commerce
    $tableName = "aetherRevolt"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/aether-revolt"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Aether%20Revolt/foil";
