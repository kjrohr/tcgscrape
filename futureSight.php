<?php 
    ...
    // Global Variables
    $setName = "Future Sight"; // Used for Categories in Crystal Commerce
    $tableName = "futureSight"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/future-sight"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Future%20Sight/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: planarChaos.php");
    // ****** END CHAIN SCRIPTS ******
?>