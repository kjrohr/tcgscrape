<?php 
    ...
    // Global Variables
    $setName = "Antiquities"; // Used for Categories in Crystal Commerce
    $tableName = "antiquities"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/antiquities"; // URL to scrape
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: arabianNights.php");
    // ****** END CHAIN SCRIPTS ******
?>