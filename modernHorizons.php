<?php 
    ...
    // Global Variables
    $setName = "Modern Horizons"; // Used for Categories in Crystal Commerce
    $tableName = "modernHorizons"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/modern-horizons"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Modern%20Horizons/foil";
