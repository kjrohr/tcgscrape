<?php 
    ...
    // Global Variables
    $setName = "Ixalan"; // Used for Categories in Crystal Commerce
    $tableName = "ixalan"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/ixalan"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Ixalan/foil";
