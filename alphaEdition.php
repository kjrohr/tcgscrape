<?php 
    ...
    // Global Variables
    $setName = "Alpha Edition"; // Used for Categories in Crystal Commerce
    $tableName = "alphaEdition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/alpha-edition"; // URL to scrape
