<?php 
    ...
    // Global Variables
    $setName = "Prophecy"; // Used for Categories in Crystal Commerce
    $tableName = "prophecy"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/prophecy"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Prophecy/foil";
