<?php 
    ...
    // Global Variables
    $setName = "Legions"; // Used for Categories in Crystal Commerce
    $tableName = "legions"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/legions"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Legions/foil";
