<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Ajani vs. Nicol Bolas"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksAjaniVsNicolBolas"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-ajani-vs-nicol-bolas"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Duel%20Decks:%20Ajani%20vs.%20Nicol%20Bolas/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksKnightsVsDragons.php");
    // ****** END CHAIN SCRIPTS ******
?>