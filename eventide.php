<?php 
    ...
    // Global Variables
    $setName = "Eventide"; // Used for Categories in Crystal Commerce
    $tableName = "eventide"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/eventide"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Eventide/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: shadowmoor.php");
    // ****** END CHAIN SCRIPTS ******
?>