<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Divine vs. Demonic"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksDivineVsDemonic"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-divine-vs-demonic"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Duel%20Decks:%20Divine%20vs.%20Demonic/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksJaceVsChandra.php");
    // ****** END CHAIN SCRIPTS ******
?>