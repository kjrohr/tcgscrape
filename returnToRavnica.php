<?php 
    ...
    // Global Variables
    $setName = "Return to Ravnica"; // Used for Categories in Crystal Commerce
    $tableName = "returnToRavnica"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/return-to-ravnica"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Return%20to%20Ravnica/foil";
