<?php 
    ...
    // Global Variables
    $setName = "Innistrad"; // Used for Categories in Crystal Commerce
    $tableName = "innistrad"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/innistrad"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Innistrad/foil";
