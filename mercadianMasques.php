<?php 
    ...
    // Global Variables
    $setName = "Mercadian Masques"; // Used for Categories in Crystal Commerce
    $tableName = "mercadianMasques"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/mercadian-masques"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Mercadian%20Masques/foil";
