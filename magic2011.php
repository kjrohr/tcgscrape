<?php 
    ...
    // Global Variables
    $setName = "Magic 2011 (M11)"; // Used for Categories in Crystal Commerce
    ...
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Magic%202011/foil";
