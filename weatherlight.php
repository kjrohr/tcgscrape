<?php 
    ...
    // Global Variables
    $setName = "Weatherlight"; // Used for Categories in Crystal Commerce
    $tableName = "weatherlight"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/weatherlight"; // URL to scrape
