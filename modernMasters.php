<?php 
    ...
    // Global Variables
    $setName = "Modern Masters"; // Used for Categories in Crystal Commerce
    $tableName = "modernMasters"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/modern-masters"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Modern%20Masters/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: modernMasters2015.php");
    // ****** END CHAIN SCRIPTS ******
?>