<?php 
    ...
    // Global Variables
    $setName = "Planeshift"; // Used for Categories in Crystal Commerce
    $tableName = "planeshift"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/planeshift"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Planeshift/foil";
