<?php 
    ...
    // Global Variables
    $setName = "Commander 2015"; // Used for Categories in Crystal Commerce
    $tableName = "commander2015"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/commander-2015"; // URL to scrape
