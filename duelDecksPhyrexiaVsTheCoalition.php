<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Phyrexia vs. The Coalition"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksPhyrexiaVsTheCoalition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-phyrexia-vs-the-coalition"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Duel%20Decks:%20Phyrexia%20vs.%20The%20Coalition/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksGarrukVsLiliana.php");
    // ****** END CHAIN SCRIPTS ******
?>