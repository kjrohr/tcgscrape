<?php 
    ...
    // Global Variables
    $setName = "Conspiracy"; // Used for Categories in Crystal Commerce
    $tableName = "conspiracy"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/conspiracy"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Conspiracy/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksSpeedVsCunning.php");
    // ****** END CHAIN SCRIPTS ******
?>