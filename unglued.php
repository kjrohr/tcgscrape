<?php 
    ...
    // Global Variables
    $setName = "Unglued"; // Used for Categories in Crystal Commerce
    $tableName = "unglued"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/unglued"; // URL to scrape
