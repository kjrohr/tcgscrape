<?php 
    ...
    // Global Variables
    $setName = "Born of the Gods"; // Used for Categories in Crystal Commerce
    $tableName = "bornOfTheGods"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/born-of-the-gods"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Born%20of%20the%20Gods/foil";
