<?php 
    ...
    // Global Variables
    $setName = "Theros"; // Used for Categories in Crystal Commerce
    $tableName = "theros"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/theros"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Theros/foil";
