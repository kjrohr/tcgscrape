<?php 
    ...
    // Global Variables
    $setName = "From the Vault: Angels"; // Used for Categories in Crystal Commerce
    $tableName = "fromTheVaultAngels"; // Used for mysql
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/From%20the%20Vault:%20Angels/foil";
