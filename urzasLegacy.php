<?php 
    ...
    // Global Variables
    $setName = "Urza's Legacy"; // Used for Categories in Crystal Commerce
    $tableName = "urzasLegacy"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/urzas-legacy"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Urza's%20Legacy/foil";
