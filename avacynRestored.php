<?php 
    ...
    // Global Variables
    $setName = "Avacyn Restored"; // Used for Categories in Crystal Commerce
    $tableName = "avacynRestored"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/avacyn-restored"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Avacyn%20Restored/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: darkAscension.php");
    // ****** END CHAIN SCRIPTS ******
?>