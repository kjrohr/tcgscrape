<?php 
    ...
    // Global Variables
    $setName = "Portal"; // Used for Categories in Crystal Commerce
    $tableName = "portal"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/portal"; // URL to scrape
