<?php 
    ...
    // Global Variables
    $setName = "Conflux"; // Used for Categories in Crystal Commerce
    $tableName = "conflux"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/conflux"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Conflux/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: shardsOfAlara.php");
    // ****** END CHAIN SCRIPTS ******
?>