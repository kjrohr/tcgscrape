<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Elspeth vs. Tezzeret"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksElspethVsTezzeret"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-elspeth-vs-tezzeret"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Duel%20Decks:%20Elspeth%20vs.%20Tezzeret/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksPhyrexiaVsTheCoalition.php");
    // ****** END CHAIN SCRIPTS ******
?>