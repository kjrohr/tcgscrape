<?php 
    ...
    // Global Variables
    $setName = "Morningtide"; // Used for Categories in Crystal Commerce
    $tableName = "morningtide"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/morningtide"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Morningtide/foil";
