<?php 
    ...
    // Global Variables
    $setName = "Dissension"; // Used for Categories in Crystal Commerce
    $tableName = "dissension"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/dissension"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Dissension/foil";
