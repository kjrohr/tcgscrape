<?php 
    ...
    // Global Variables
    $setName = "Worldwake"; // Used for Categories in Crystal Commerce
    $tableName = "worldwake"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/worldwake"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Worldwake/foil";
