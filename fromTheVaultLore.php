<?php 
    ...
    // Global Variables
    $setName = "From the Vault: Lore"; // Used for Categories in Crystal Commerce
    $tableName = "fromTheVaultLore"; // Used for mysql
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/From%20the%20Vault:%20Lore/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: fromTheVaultAngels.php");
    // ****** END CHAIN SCRIPTS ******
?>