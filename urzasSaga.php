<?php 
    ...
    // Global Variables
    $setName = "Urza's Saga"; // Used for Categories in Crystal Commerce
    $tableName = "urzasSaga"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/urzas-saga"; // URL to scrape
