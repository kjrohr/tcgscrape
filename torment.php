<?php 
    ...
    // Global Variables
    $setName = "Torment"; // Used for Categories in Crystal Commerce
    $tableName = "torment"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/torment"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Torment/foil";
