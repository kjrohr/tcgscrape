<?php 
    ...
    // Global Variables
    $setName = "Commander 2017"; // Used for Categories in Crystal Commerce
    $tableName = "commander2017"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/commander-2017"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Commander%202017/foil";
