<?php 
    ...
    // Global Variables
    $setName = "The Dark"; // Used for Categories in Crystal Commerce
    $tableName = "theDark"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/the-dark"; // URL to scrape
