<?php 
    ...
    // Global Variables
    $setName = "7th Edition"; // Used for Categories in Crystal Commerce
    $tableName = "7thEdition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/7th-edition"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Seventh%20Edition/foil";
