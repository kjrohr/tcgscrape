<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Jace vs. Vraska"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksJaceVsVraska"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-jace-vs-vraska"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Duel%20Decks:%20Jace%20vs.%20Vraska/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksHeroesVsMonsters.php");
    // ****** END CHAIN SCRIPTS ******
?>