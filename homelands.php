<?php 
    ...
    // Global Variables
    $setName = "Homelands"; // Used for Categories in Crystal Commerce
    $tableName = "homelands"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/homelands"; // URL to scrape
