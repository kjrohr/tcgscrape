<?php 
    ...
    // Global Variables
    $setName = "Mirrodin Besieged"; // Used for Categories in Crystal Commerce
    $tableName = "mirrodinBesieged"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/mirrodin-besieged"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Mirrodin%20Besieged/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: modernMasters.php");
    // ****** END CHAIN SCRIPTS ******
?>