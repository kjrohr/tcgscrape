<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Speed vs. Cunning"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksSpeedVsCunning"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-speed-vs-cunning"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Duel%20Decks:%20Speed%20vs.%20Cunning/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksJaceVsVraska.php");
    // ****** END CHAIN SCRIPTS ******
?>