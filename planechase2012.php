<?php 
    ...
    // Global Variables
    $setName = "Planechase 2012"; // Used for Categories in Crystal Commerce
    $tableName = "planechase2012"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/planechase-2012"; // URL to scrape
