<?php 
    ...
    // Global Variables
    $setName = "Invasion"; // Used for Categories in Crystal Commerce
    $tableName = "invasion"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/invasion"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Invasion/foil";
