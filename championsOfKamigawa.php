<?php 
    ...
    // Global Variables
    $setName = "Champions of Kamigawa"; // Used for Categories in Crystal Commerce
    $tableName = "championsOfKamigawa"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/champions-of-kamigawa"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Champions%20of%20Kamigawa/foil";
