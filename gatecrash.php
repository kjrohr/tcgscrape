<?php 
    ...
    // Global Variables
    $setName = "Gatecrash"; // Used for Categories in Crystal Commerce
    $tableName = "gatecrash"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/gatecrash"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Gatecrash/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: returnToRavnica.php");
    // ****** END CHAIN SCRIPTS ******
?>