<?php 
    ...
    // Global Variables
    $setName = "8th Edition"; // Used for Categories in Crystal Commerce
    $tableName = "8thEdition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/8th-edition"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Eighth%20Edition/foil";
