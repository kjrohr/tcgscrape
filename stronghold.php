<?php 
    ...
    // Global Variables
    $setName = "Stronghold"; // Used for Categories in Crystal Commerce
    $tableName = "stronghold"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/stronghold"; // URL to scrape
