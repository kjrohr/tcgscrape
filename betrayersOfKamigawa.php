<?php 
    ...
    // Global Variables
    $setName = "Betrayers of Kamigawa"; // Used for Categories in Crystal Commerce
    $tableName = "betrayersOfKamigawa"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/betrayers-of-kamigawa"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Betrayers%20of%20Kamigawa/foil";
