<?php 
    ...
    // Global Variables
    $setName = "Exodus"; // Used for Categories in Crystal Commerce
    $tableName = "exodus"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/exodus"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Exodus/foil";
