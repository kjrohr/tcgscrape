<?php 
    ...
    // Global Variables
    $setName = "Commander 2016"; // Used for Categories in Crystal Commerce
    $tableName = "commander2016"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/commander-2016"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Commander%202016/foil";
