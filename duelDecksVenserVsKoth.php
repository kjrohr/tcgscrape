<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Venser vs. Koth"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksVenserVsKoth"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-venser-vs-koth"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Duel%20Decks:%20Venser%20vs.%20Koth/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksAjaniVsNicolBolas.php");
    // ****** END CHAIN SCRIPTS ******
?>