<?php 
    ...
    // Global Variables
    $setName = "Tempest"; // Used for Categories in Crystal Commerce
    $tableName = "tempest"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/tempest"; // URL to scrape
