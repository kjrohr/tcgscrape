<?php 
    ...
    // Global Variables
    $setName = "Onslaught"; // Used for Categories in Crystal Commerce
    $tableName = "onslaught"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/onslaught"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Onslaught/foil";
