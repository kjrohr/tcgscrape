<?php 
    ...
    // Global Variables
    $setName = "Ice Age"; // Used for Categories in Crystal Commerce
    $tableName = "iceAge"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/ice-age"; // URL to scrape
