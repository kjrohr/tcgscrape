<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Garruk vs. Liliana"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksGarrukVsLiliana"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-garruk-vs-liliana"; // URL to scrape
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksDivineVsDemonic.php");
    // ****** END CHAIN SCRIPTS ******
?>