<?php 
    ...
    // Global Variables
    $setName = "Magic Modern Event Deck"; // Used for Categories in Crystal Commerce
    $tableName = "magicModernEventDeck"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/magic-modern-event-deck"; // URL to scrape
