<?php 
    ...
    // Global Variables
    $setName = "Fallen Empires"; // Used for Categories in Crystal Commerce
    $tableName = "fallenEmpires"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/fallen-empires"; // URL to scrape
