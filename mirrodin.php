<?php 
    ...
    // Global Variables
    $setName = "Mirrodin"; // Used for Categories in Crystal Commerce
    $tableName = "mirrodin"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/mirrodin"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Mirrodin/foil";
