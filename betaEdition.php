<?php 
    ...
    // Global Variables
    $setName = "Beta Edition"; // Used for Categories in Crystal Commerce
    $tableName = "betaEdition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/beta-edition"; // URL to scrape
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: alphaEdition.php");
    // ****** END CHAIN SCRIPTS ******
?>