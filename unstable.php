<?php 
    ...
    // Global Variables
    $setName = "Unstable"; // Used for Categories in Crystal Commerce
    $tableName = "unstable"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/unstable"; // URL to scrape
  ...
  // ****** GENERATE MASTER CSV ******
    ...
    // ****** CHAIN SCRIPTS ******
      ...
      header("Location: iconicMasters.php");
    // ****** END CHAIN SCRIPTS ******
?>