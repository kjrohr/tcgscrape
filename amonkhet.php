<?php 
    ...
    // Global Variables
    $setName = "Amonkhet"; // Used for Categories in Crystal Commerce
    $tableName = "amonkhet"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/amonkhet"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Amonkhet/foil";
