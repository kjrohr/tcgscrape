<?php 
    ...
    // Global Variables
    $setName = "Time Spiral"; // Used for Categories in Crystal Commerce
    $tableName = "timeSpiral"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/time-spiral"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Time%20Spiral/foil";
