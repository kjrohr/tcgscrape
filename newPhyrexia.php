<?php 
    ...
    // Global Variables
    $setName = "New Phyrexia"; // Used for Categories in Crystal Commerce
    $tableName = "newPhyrexia"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/new-phyrexia"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/New%20Phyrexia/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: mirrodinBesieged.php");
    // ****** END CHAIN SCRIPTS ******
?>