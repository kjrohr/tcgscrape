<?php 
    ...
    // Global Variables
    $setName = "Ravnica: City of Guilds"; // Used for Categories in Crystal Commerce
    $tableName = "ravnicaCityOfGuilds"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/ravnica-city-of-guilds"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Ravnica:%20City%20of%20Guilds/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: saviorsOfKamigawa.php");
    // ****** END CHAIN SCRIPTS ******
?>