<?php 
    ...
    // Global Variables
    $setName = "Shadows Over Innistrad"; // Used for Categories in Crystal Commerce
    $tableName = "shadowsOverInnistrad"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/shadows-over-innistrad"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Shadows%20Over%20Innistrad/foil";
