<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Sorin vs. Tibalt"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksSorinVsTibalt"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-sorin-vs-tibalt"; // URL to scrape
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksIzzetVsGolgari.php");
    // ****** END CHAIN SCRIPTS ******
?>