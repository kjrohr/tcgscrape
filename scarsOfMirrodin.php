<?php 
    ...
    // Global Variables
    $setName = "Scars of Mirrodin"; // Used for Categories in Crystal Commerce
    $tableName = "scarsOfMirrodin"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/scars-of-mirrodin"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Scars%20of%20Mirrodin/foil";
