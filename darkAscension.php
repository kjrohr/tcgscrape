<?php 
    ...
    // Global Variables
    $setName = "Dark Ascension"; // Used for Categories in Crystal Commerce
    $tableName = "darkAscension"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/dark-ascension"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Dark%20Ascension/foil";
