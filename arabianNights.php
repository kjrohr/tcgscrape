<?php 
    ...
    // Global Variables
    $setName = "Arabian Nights"; // Used for Categories in Crystal Commerce
    $tableName = "arabianNights"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/arabian-nights"; // URL to scrape
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: commandersArsenal.php");
    // ****** END CHAIN SCRIPTS ******
?>