<?php 
    ...
    // Global Variables
    $setName = "Mirage"; // Used for Categories in Crystal Commerce
    $tableName = "mirage"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/mirage"; // URL to scrape
