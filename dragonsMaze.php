<?php 
    ...
    // Global Variables
    $setName = "Dragon's Maze"; // Used for Categories in Crystal Commerce
    $tableName = "dragonsMaze"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/dragons-maze"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Dragon's%20Maze/foil";
