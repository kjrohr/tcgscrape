<?php 
    ...
    // Global Variables
    $setName = "Portal Second Age"; // Used for Categories in Crystal Commerce
    $tableName = "portalSecondAge"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/portal-second-age"; // URL to scrape
