<?php 
    ...
    // Global Variables
    $setName = "Apocalypse"; // Used for Categories in Crystal Commerce
    $tableName = "apocalypse"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/apocalypse"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Apocalypse/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: 7thEdition.php");
    // ****** END CHAIN SCRIPTS ******
?>