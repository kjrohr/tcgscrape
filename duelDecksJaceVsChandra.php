<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Jace vs. Chandra"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksJaceVsChandra"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-jace-vs-chandra"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Duel%20Decks:%20Jace%20vs.%20Chandra/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksElvesVsGoblins.php");
    // ****** END CHAIN SCRIPTS ******
?>