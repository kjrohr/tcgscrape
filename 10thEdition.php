<?php 
    ...
    // Global Variables
    $setName = "10th Edition"; // Used for Categories in Crystal Commerce
    $tableName = "10thEdition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/10th-edition"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Tenth%20Edition/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: futureSight.php");
    // ****** END CHAIN SCRIPTS ******
?>