<?php 
    ...
    // Global Variables
    $setName = "From the Vault: Legends"; // Used for Categories in Crystal Commerce
    $tableName = "fromTheVaultLegends"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/from-the-vault-legends"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/From%20the%20Vault:%20Legends/foil";
