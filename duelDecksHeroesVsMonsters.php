<?php 
    ...
    // Global Variables
    $setName = "Duel Decks: Heroes vs. Monsters"; // Used for Categories in Crystal Commerce
    $tableName = "duelDecksHeroesVsMonsters"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/duel-decks-heroes-vs-monsters"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Duel%20Decks:%20Garruk%20vs.%20Liliana/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: duelDecksSorinVsTibalt.php");
    // ****** END CHAIN SCRIPTS ******
?>