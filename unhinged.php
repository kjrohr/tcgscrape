<?php 
    ...
    // Global Variables
    $setName = "Unhinged"; // Used for Categories in Crystal Commerce
    $tableName = "unhinged"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/unhinged"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Unhinged/foil";
