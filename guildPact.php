<?php 
    ...
    // Global Variables
    $setName = "Guildpact"; // Used for Categories in Crystal Commerce
    $tableName = "guildpact"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/guildpact"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Guildpact/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: ravnicaCityOfGuilds.php");
    // ****** END CHAIN SCRIPTS ******
?>