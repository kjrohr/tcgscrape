<?php 
    ...
    // Global Variables
    $setName = "Planar Chaos"; // Used for Categories in Crystal Commerce
    $tableName = "planarChaos"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/planar-chaos"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Planar%20Chaos/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: timeSpiral.php");
    // ****** END CHAIN SCRIPTS ******
?>