<?php 
    ...
    // Global Variables
    $setName = "Scourge"; // Used for Categories in Crystal Commerce
    $tableName = "scourge"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/scourge"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Scourge/foil";
