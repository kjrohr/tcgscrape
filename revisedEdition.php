<?php 
    ...
    // Global Variables
    $setName = "Revised Edition"; // Used for Categories in Crystal Commerce
    $tableName = "revisedEdition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/revised-edition"; // URL to scrape
  ...
  // ****** GENERATE MASTER CSV ******
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: antiquities.php");
    // ****** END CHAIN SCRIPTS ******
?>