<?php 
    ...
    // Global Variables
    $setName = "Zendikar"; // Used for Categories in Crystal Commerce
    $tableName = "zendikar"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/zendikar"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Zendikar/foil";
