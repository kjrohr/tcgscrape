<?php 
    ...
    // Global Variables
    $setName = "Darksteel"; // Used for Categories in Crystal Commerce
    $tableName = "darksteel"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/darksteel"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Darksteel/foil";
