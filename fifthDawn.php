<?php 
    ...
    // Global Variables
    $setName = "Fifth Dawn"; // Used for Categories in Crystal Commerce
    $tableName = "fifthDawn"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/fifth-dawn"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Fifth%20Dawn/foil";
