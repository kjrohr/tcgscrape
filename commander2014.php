<?php 
    ...
    // Global Variables
    $setName = "Commander 2014"; // Used for Categories in Crystal Commerce
    $tableName = "commander2014"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/commander-2014"; // URL to scrape
