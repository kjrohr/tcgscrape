<?php 
    ...
    // Global Variables
    $setName = "Alliances"; // Used for Categories in Crystal Commerce
    $tableName = "alliances"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/alliances"; // URL to scrape
