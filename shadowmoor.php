<?php 
    ...
    // Global Variables
    $setName = "Shadowmoor"; // Used for Categories in Crystal Commerce
    $tableName = "shadowmoor"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/shadowmoor"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Shadowmoor/foil";
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: morningtide.php");
    // ****** END CHAIN SCRIPTS ******
?>