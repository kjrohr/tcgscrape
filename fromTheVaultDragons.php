<?php 
    ...
    // Global Variables
    $setName = "From the Vault: Dragons"; // Used for Categories in Crystal Commerce
    $tableName = "fromTheVaultDragons"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/from-the-vault-dragons"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/From%20the%20Vault:%20Dragons/foil";
