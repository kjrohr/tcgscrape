<?php 
    ...
    // Global Variables
    $setName = "Commander 2013"; // Used for Categories in Crystal Commerce
    $tableName = "commander2013"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/commander-2013"; // URL to scrape
