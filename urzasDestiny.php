<?php 
    ...
    // Global Variables
    $setName = "Urza's Destiny"; // Used for Categories in Crystal Commerce
    $tableName = "urzasDestiny"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/urzas-destiny"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Urza's%20Destiny/foil";
