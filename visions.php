<?php 
    ...
    // Global Variables
    $setName = "Visions"; // Used for Categories in Crystal Commerce
    $tableName = "visions"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/visions"; // URL to scrape
