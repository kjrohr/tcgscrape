<?php 
    ...
    // Global Variables
    $setName = "Ultimate Masters"; // Used for Categories in Crystal Commerce
    $tableName = "ultimateMasters"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/ultimate-masters"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Ultimate%20Masters/foil";
    ...
    // ****** CHAIN SCRIPTS ******
    header("Location: guildsOfRavnica.php");
    // ****** END CHAIN SCRIPTS ******
?>