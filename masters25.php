<?php 
    ...
    // Global Variables
    $setName = "Masters 25"; // Used for Categories in Crystal Commerce
    $tableName = "masters25"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/masters-25"; // URL to scrape
    $quietSpeculationURL = "https://www.quietspeculation.com/tradertools/prices/sets/Masters%2025/foil";
