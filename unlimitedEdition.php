<?php 
    ...
    // Global Variables
    $setName = "Unlimited Edition"; // Used for Categories in Crystal Commerce
    $tableName = "unlimitedEdition"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/unlimited-edition"; // URL to scrape
    ...
    // ****** CHAIN SCRIPTS ******
      header("Location: betaEdition.php");
    // ****** END CHAIN SCRIPTS ******
?>