<?php 
    ...
    // Global Variables
    $setName = "Chronicles"; // Used for Categories in Crystal Commerce
    $tableName = "chronicles"; // Used for mysql
    $tcgPlayerSetURL = "https://shop.tcgplayer.com/price-guide/magic/chronicles"; // URL to scrape
